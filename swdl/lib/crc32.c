...
*/
/* Modifications by Allen Wild, 2018:
 *   - removed libiberty header includes
 *   - use types from stdint.h
 *   - update crc value through pointer rather than returning
 */
...
void
xcrc32 (uint32_t *_crc, const uint8_t *buf, ssize_t len)
{
  uint32_t crc = *_crc;
  while (len--)
    {
